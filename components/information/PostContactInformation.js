...
export default class PostContactInformation extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            formData: {
    ...
    _DangThongBao = async () => {
        ...
        await fetch(host + '/information/PostContactInformation.php', {
            method: 'POST',
            headers: {
    ...
    render() {
        ...
        return (
            <ScrollView style={{ flex: 1, padding: 5 }}>
                ...
                <Text style={styles.btnDangThongBao} onPress={this._DangThongBao}>Đăng thông tin</Text>
